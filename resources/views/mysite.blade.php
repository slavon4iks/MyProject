...
{{--    <link href="{{ asset('css/bootstrap.min.css') }} " rel="stylesheet" />--}}
    ...
    <link href="{{asset('http://fonts.googleapis.com/css?family=Lato:300,400,300italic,400italic')}}" rel='stylesheet' type='text/css'>
    ...
    <!-- github calendar css -->
    <link rel="stylesheet" href="{{asset('plugins/github-calendar/dist/github-calendar.css')}}"
/>
    <!-- github acitivity css -->
    <link rel="stylesheet" href="{{asset('plugins/github-activity/src/github-activity.css')}}">
    <link rel="stylesheet" href="{{asset('//cdnjs.cloudflare.com/ajax/libs/octicons/2.0.2/octicons.min.css')}}">
...
<body>
    ...
    <header class="header">
        <div class="container">
            <img class="profile-image img-responsive pull-left" src="{{asset('images/profile.png')}}" alt="James Lee" />
            ...
            <a class="btn btn-cta-primary pull-right" href="{{asset('http://themes.3rdwavemedia.com/')}}" target="_blank"><i class="fa fa-paper-plane"></i> Contact Me</a>
        </div><!--//container-->
    </header><!--//header-->
               ...
               <section class="latest section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            ...
                            <div class="item featured text-center">
                                <h3 class="title"><a href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-products-velocity/')}}" target="_blank">KickStarter - Velocity</a></h3>
                                <p class="summary">A responsive Bootstrap template designed for digital products</p>
                                <div class="featured-image">
                                    <a href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-products-velocity/')}}" target="_blank">
                                ...
                                <a class="btn btn-cta-secondary" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-products-velocity/')}}" target="_blank"><i class="fa fa-thumbs-o-up"></i> Back my project</a>
                            </div><!--//item-->
                            <hr class="divider" />
                            <div class="item row">
                                <a class="col-md-4 col-sm-4 col-xs-12" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-mobile-apps-atom/')}}" target="_blank">
                                <img class="img-responsive project-image" src="{{asset('images/projects/project-5.png')}}" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 class="title"><a href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-mobile-apps-atom/')}}" target="_blank">Atom - Designed for Mobile Apps</a></h3>
                                    ...
                                    <p><a class="more-link" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-mobile-apps-atom/')}}" target="_blank"><i class="fa fa-external-link"></i> Find out more</a></p>
                                </div><!--//desc-->
                            </div><!--//item-->

                            <div class="item row">
                                <a class="col-md-4 col-sm-4 col-xs-12" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-web-development-agencies-devstudio/')}}" target="_blank">
                                <img class="img-responsive project-image" src="{{asset('images/projects/project-4.png')}}" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 class="title"><a href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-web-development-agencies-devstudio/')}}" target="_blank">DevStudio - Designed for Web Development Agencies</a></h3>
                                    <p>You can put one of your secondary projects here. Suspendisse in tellus dolor. Vivamus a tortor eu turpis pharetra consequat quis non metus. Aliquam aliquam, orci eu suscipit pellentesque, mauris dui tincidunt enim, eget iaculis ante dolor non turpis.</p>
                                    <p><a class="more-link" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-web-development-agencies-devstudio/')}}" target="_blank"><i class="fa fa-external-link"></i> Find out more</a></p>
                                </div><!--//desc-->
                            </div><!--//item-->

                            <div class="item row">
                                <a class="col-md-4 col-sm-4 col-xs-12" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-startups-tempo/')}}" target="_blank">
                                <img class="img-responsive project-image" src="{{asset('assets/images/projects/project-1.png')}}" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 class="title"><a href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-startups-tempo/')}}" target="_blank">Tempo - Designed for Startups</a></h3>
                                    <p>You can put one of your secondary projects here. Suspendisse in tellus dolor. Vivamus a tortor eu turpis pharetra consequat quis non metus. Aliquam aliquam, orci eu suscipit pellentesque, mauris dui tincidunt enim, eget iaculis ante dolor non turpis.</p>
                                    <p><a class="more-link" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-startups-tempo/')}}" target="_blank"><i class="fa fa-external-link"></i> Find out more</a></p>
                                </div><!--//desc-->
                            </div><!--//item-->
                            <div class="item row">
                                <a class="col-md-4 col-sm-4 col-xs-12" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-mobile-apps-delta/')}}" target="_blank">
                                <img class="img-responsive project-image" src="{{asset('images/projects/project-2.png')}}" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 class="title"><a href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-mobile-apps-delta/')}}" target="_blank">Delta - Designed for Mobile Apps</a></h3>
                                    ...
                                    <p><a class="more-link" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-mobile-apps-delta/')}}" target="_blank"><i class="fa fa-external-link"></i> Find out more</a></p>
                                </div><!--//desc-->
                            </div><!--//item-->
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            ...
                            <div class="item">
                                ...
                                <p><a class="more-link" href="{{asset('http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-mobile-apps-delta/')}}" target="_blank"><i class="fa fa-external-link"></i> View on GitHub</a></p>
                            </div><!--//item-->
                            <div class="item">
                ...
                <section class="github section">
                    <div class="section-inner">
                        ...
                        <p>You can embed your GitHub contribution graph calendar using IonicaBizau's <a href="{{asset('https://github.com/IonicaBizau/github-calendar')}}" target="_blank">GitHub Calendar</a> widget.

                        <div id="github-graph" class="github-graph">

                        </div><!--//github-graph-->

                        <p>You can also embed your GitHub activities using Casey Scarborough's <a href="{{asset('http://caseyscarborough.com/projects/github-activity/')}}" target="_blank">GitHub Activity Stream</a> widget.
            ...
            <div class="secondary col-md-4 col-sm-12 col-xs-12">
                ...
                <aside class="blog aside section">
                    <div class="section-inner">
                        ...
                        <p>You can use Sascha Depold's <a href="{{asset('https://github.com/sdepold/jquery-rss')}}" target="_blank">jQuery RSS plugin</a> to pull in your blog post feeds.</p>
                ...
                <aside class="list conferences aside section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fa fa-calendar"></i> <a href="{{asset('https://developer.apple.com/wwdc/')}}" target="_blank">WWDC 2014</a> (San Francisco)</li>
                                <li><i class="fa fa-calendar"></i> <a href="{{asset('http://hive.aigaseattle.org/')}}">Hive</a> (Seattle)</li>
                            </ul>
                        </div><!--//content-->
                    </div><!--//section-inner-->
                </aside><!--//section-->
                ...
                <aside class="credits aside section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><a href="{{asset('http://hive.aigaseattle.org/')}}" target="_blank"><i class="fa fa-external-link"></i> Bootstrap</a></li>
                                <li><a href="{{asset('http://fortawesome.github.io/Font-Awesome/')}}" target="_blank"><i class="fa fa-external-link"></i> FontAwesome</a></li>
                                <li><a href="{{asset('http://jquery.com/" target="_blank')}}"><i class="fa fa-external-link"></i> jQuery</a></li>
                                <li><a href="{{asset('https://github.com/IonicaBizau/github-calendar')}}" target="_blank"><i class="fa fa-external-link"></i> GitHub Calendar Plugin</a></li>

                                <li><a href="{{asset('http://caseyscarborough.com/projects/github-activity/')}}" target="_blank"><i class="fa fa-external-link"></i> GitHub Activity Stream</a></li>

                                <li><a href="{{asset('https://github.com/sdepold/jquery-rss')}}" target="_blank"><i class="fa fa-external-link"></i> jQuery RSS</a></li>

                                <li>Profile image: <a href="{{asset('https://www.flickr.com/photos/dotbenjamin/2577394151')}}" target="_blank">Ben Smith</a></li>
                                <li>iPad and iPhone mocks: <a href="{{asset('https://dribbble.com/perlerar')}}" target="_blank">Regy Perlera</a></li>

                            </ul>

                            <hr/>

                             <p>This responsive portfolio template is handcrafted by UX designer <a href="{{asset('https://www.linkedin.com/in/xiaoying')}}" target="_blank">Xiaoying Riley</a> at <a href="http://themes.3rdwavemedia.com/" target="_blank">3rd Wave Media</a> for developers and is <strong>FREE</strong> under the <a class="dotted-link" href="http://creativecommons.org/licenses/by/3.0/" target="_blank">Creative Commons Attribution 3.0 License</a></p>
                            ...
                            <a class="btn btn-cta-secondary btn-follow" href="{{asset('https://twitter.com/3rdwave_themes')}}" target="_blank"><i class="fa fa-twitter"></i> Follow us</a>
                            <a class="btn btn-cta-primary btn-download" href="{{asset('http://themes.3rdwavemedia.com/website-templates/free-responsive-website-template-for-developers/')}}" target="_blank"><i class="fa fa-download"></i> I want to download</a>
                        </div><!--//content-->
                    </div><!--//section-inner-->
                </aside><!--//section-->
    ...
    <footer class="footer">
        <div class="container text-center">
                ...
                <small class="copyright">Designed with <i class="fa fa-heart"></i> by <a href="{{asset('http://themes.3rdwavemedia.com')}}" target="_blank">Xiaoying Riley</a> for developers</small>
        </div><!--//container-->
    </footer><!--//footer-->
    ...
    <script type="text/javascript" src="{{asset('plugins/jquery-rss/dist/jquery.rss.min.js')}}"></script>
    <!-- github calendar plugin -->
    <script type="text/javascript" src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/es6-promise/3.0.2/es6-promise.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/fetch/0.10.1/fetch.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/plugins/github-calendar/dist/github-calendar.min.js')}}"></script>
    <!-- github activity plugin -->
    <script type="text/javascript" src="{{asset('//cdnjs.cloudflare.com/ajax/libs/mustache.js/0.7.2/mustache.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('plugins/github-activity/src/github-activity.js')}}"></script>
    <!-- custom js -->
